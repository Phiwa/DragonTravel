...
public class CheatProtectionHandler {
	...
	public static void exemptPlayerFromCheatChecks(Player player) {
		...
		// NoCheatPlus
		if (DragonTravelMain.nocheatplus && !fr.neatmonster.nocheatplus.hooks.NCPExemptionManager.isExempted(player, fr.neatmonster.nocheatplus.checks.CheckType.MOVING_SURVIVALFLY) && !fr.neatmonster.nocheatplus.hooks.NCPExemptionManager.isExempted(player, fr.neatmonster.nocheatplus.checks.CheckType.MOVING_CREATIVEFLY)) {
			fr.neatmonster.nocheatplus.hooks.NCPExemptionManager.exemptPermanently(player, fr.neatmonster.nocheatplus.checks.CheckType.MOVING_SURVIVALFLY);
			fr.neatmonster.nocheatplus.hooks.NCPExemptionManager.exemptPermanently(player, fr.neatmonster.nocheatplus.checks.CheckType.MOVING_CREATIVEFLY);
		}
	}
