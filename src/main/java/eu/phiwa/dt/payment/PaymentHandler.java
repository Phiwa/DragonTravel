...
public class PaymentHandler {
	 ...
	 * 
	 * @param customcost A custom cost which can be specified. When using a
	 *             payment via resources, the double is converted to an
	 *             integer and loses its part behind the point
	 * @param player
	 * @return Payment successful? If usePayment is set to false in the
	 *         config, this returns "true"
	 */
	 ...
	 * 
	 * @param paymenttype A constant defined in DragonTravelMain which is
	 *             used to get the default cost for this paymenttype from the
	 *             config.
	 * @param player
	 * @return Payment successful? If usePayment is set to false in the
	 *         config, this returns "true"
	...
	/**
	 * Is run if the config-option (payment via economy) is set to true If no
	 * economy-provider is available, it disables useEconomy
	 * 
	 */
	public void setupEconomy() {
		RegisteredServiceProvider<Economy> economyProviderTemp = server.getServicesManager().getRegistration(net.milkbowl.vault.economy.Economy.class);
