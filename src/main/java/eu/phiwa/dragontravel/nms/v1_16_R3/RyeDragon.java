...
package eu.phiwa.dragontravel.nms.v1_16_R3;
...
public class RyeDragon extends EntityEnderDragon implements IRyeDragon {
    ...
    private void setX( double x ) { setPosition( x, locY(), locZ() ); }
    private void setY( double y ) { setPosition( locX(), y, locZ() ); }
    private void setZ( double z ) { setPosition( locX(), locY(), z ); }
    ...
    public void setCustomDragonName(String name) {
        net.minecraft.server.v1_16_R3.IChatBaseComponent nameInNewType = CraftChatMessage.fromString(name)[0]; // convert from "name"
    ...
    // New (in CB 1_13_R1)
    public void setCustomName(net.minecraft.server.v1_16_R3.IChatBaseComponent name) {
    ...
    public String getCustomDragonName() {
        // Call new method
        net.minecraft.server.v1_16_R3.IChatBaseComponent nameInNewType = getCustomName();
        String nameAsString = CraftChatMessage.fromComponent(nameInNewType); // convert from "nameInNewType"
        return nameAsString;
    }

    // New (in CB 1_13_R1)
    public net.minecraft.server.v1_16_R3.IChatBaseComponent getCustomName() {
