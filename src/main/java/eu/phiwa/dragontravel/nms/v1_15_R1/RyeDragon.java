...
public class RyeDragon extends EntityEnderDragon implements IRyeDragon {
    ...
    public void setCustomDragonName(String name) {
        net.minecraft.server.v1_15_R1.IChatBaseComponent nameInNewType = CraftChatMessage.fromString(name)[0]; // convert from "name"
    ...
    // New (in CB 1_13_R1)
    public void setCustomName(net.minecraft.server.v1_15_R1.IChatBaseComponent name) {
    ...
    public String getCustomDragonName() {
        // Call new method
        net.minecraft.server.v1_15_R1.IChatBaseComponent nameInNewType = getCustomName();
        String nameAsString = CraftChatMessage.fromComponent(nameInNewType); // convert from "nameInNewType"
        return nameAsString;
    }

    // New (in CB 1_13_R1)
    public net.minecraft.server.v1_15_R1.IChatBaseComponent getCustomName() {
